...
<html>
    ...
    <body>
        <%
            ...
            SistemaOrigen sistema = (SistemaOrigen) request.getSession().getAttribute("sistemaOrigen");
        %>
        ...
        <fieldset class="wrapper">
            <legend>Editar Sistema de Origen</legend>             
            <%
                ...
                <form method="post" action="../sistemaOrigen">
                    <table>
                        <tr>
                            ...
                            <td><input style="background-color: grey; color: white" type="number" name="id" readonly value="<%=sistema.getId()%>"/></td>
                        </tr>
                        <tr>
                            <td class="firstColumn">Nombre:</td>
                            <td><input type="text" name="nombre" value="<%=sistema.getNombre().trim()%>"/></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
