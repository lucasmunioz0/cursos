...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://soap.sga.udemy.com/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://soap.sga.udemy.com/", "listarPersonasResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.sga.udemy.com/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.sga.udemy.com/", name = "listarPersonasResponse")
