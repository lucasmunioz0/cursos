 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://services.sga.udemy.com/", wsdlLocation = "http://lucas-pc:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://services.sga.udemy.com/", "PersonaServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://lucas-pc:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl");
     ...
     * 
     * @return
     *     returns PersonaServicesWS
     */
    @WebEndpoint(name = "PersonaServiceImplPort")
    public PersonaServicesWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://services.sga.udemy.com/", "PersonaServiceImplPort"), PersonaServicesWS.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonaServiceImplPort")
    public PersonaServicesWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.sga.udemy.com/", "PersonaServiceImplPort"), PersonaServicesWS.class, features);
    }
