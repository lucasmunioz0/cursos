...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://beans.sga.javaee.udemy.com/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://beans.sga.javaee.udemy.com/", "sumarResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.sga.javaee.udemy.com/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://beans.sga.javaee.udemy.com/", name = "sumarResponse")
