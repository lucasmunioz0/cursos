 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans.sga.javaee.udemy.com/", wsdlLocation = "http://localhost:8080/ServicioSumarImplService/ServicioSumarImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOSUMARIMPLSERVICE_QNAME = new QName("http://beans.sga.javaee.udemy.com/", "ServicioSumarImplService");
    ...
    public ServicioSumarWS getServicioSumarImplPort() {
        return super.getPort(new QName("http://beans.sga.javaee.udemy.com/", "ServicioSumarImplPort"), ServicioSumarWS.class);
    }
    ...
    public ServicioSumarWS getServicioSumarImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://beans.sga.javaee.udemy.com/", "ServicioSumarImplPort"), ServicioSumarWS.class, features);
    }
